...
public class ConsumerManagerTest {
  ...
  @Test
  public void testReadInvalidTopicFails() {
  ...
  private void readTopic(final String cid,
                         long maxBytes,
                         final ConsumerReadCallback callback) throws Exception {
  ...
  private void readTopic(final String cid,
                         ...
                         long maxBytes,
                         final ConsumerReadCallback callback) throws Exception {
    // Add a bit of fuzz to the wait time to
